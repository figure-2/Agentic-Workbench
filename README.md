...
Next implementation track: manual provider test execution readiness decision record. It must still keep external calls closed by default until a later explicit opt-in task.
