...
Next implementation track: first manual provider test preflight audit bundle. It must still keep external calls closed by default until a later explicit opt-in task.
