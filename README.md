...
Next implementation track: no-call manual provider test review packet. It must still keep external calls closed by default until a later explicit opt-in task.
