...
Next implementation track: disabled first-call final no-call execution authorization capsule boundary. It must still keep external calls closed by default until a later explicitly approved call-opening task.
