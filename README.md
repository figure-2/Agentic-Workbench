...
Next implementation track: no-call execution authorization release proposal. It must still keep external calls closed by default until a later explicitly approved call-opening task.
