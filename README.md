...
Next implementation track: explicit one-shot live call permission contract. It must still keep external calls closed by default until a later explicit opt-in task.
