...
Next implementation track: disabled first-call executor dispatch record boundary. It must still keep external calls closed by default until a later explicitly approved call-opening task.
