...
Next implementation track: disabled first-call release authorization seal boundary. It must still keep external calls closed by default until a later explicitly approved call-opening task.
