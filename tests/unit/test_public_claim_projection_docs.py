...
LIVE_45_PATH = (
    ROOT / "docs" / "evals" / "aw-live-45-execution-capsule-authz-release-seal.md"
)
LIVE_45_RUNBOOK_PATH = (
    ROOT / "docs" / "runbooks" / "aw-live-45-execution-capsule-authz-release-seal.md"
)
LIVE_45_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-45-execution-capsule-authz-release-seal.md"
)
LIVE_46_PATH = (
    ROOT
    / "docs"
    / "evals"
    / "aw-live-46-execution-capsule-authz-final-authorization.md"
)
LIVE_46_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-46-execution-capsule-authz-final-authorization.md"
)
LIVE_46_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-46-execution-capsule-authz-final-authorization.md"
...
LIVE_47_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-47-execution-capsule-authz-final-authz-export.md"
)
LIVE_47_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-47-execution-capsule-authz-final-authz-export.md"
)
LIVE_47_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-47-execution-capsule-authz-final-authz-export.md"
...
LIVE_48_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-48-execution-capsule-authz-final-authz-handoff.md"
)
LIVE_48_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-48-execution-capsule-authz-final-authz-handoff.md"
)
LIVE_48_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-48-execution-capsule-authz-final-authz-handoff.md"
...
LIVE_49_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-49-execution-capsule-authz-final-authz-operator-review.md"
)
LIVE_49_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-49-execution-capsule-authz-final-authz-operator-review.md"
)
LIVE_49_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-49-execution-capsule-authz-final-authz-operator-review.md"
...
LIVE_50_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-50-execution-capsule-authz-final-authz-operator-decision.md"
)
LIVE_50_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-50-execution-capsule-authz-final-authz-operator-decision.md"
)
LIVE_50_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-50-execution-capsule-authz-final-authz-operator-decision.md"
...
LIVE_51_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-51-execution-capsule-authz-final-authz-release-attestation.md"
)
LIVE_51_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-51-execution-capsule-authz-final-authz-release-attestation.md"
)
LIVE_51_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-51-execution-capsule-authz-final-authz-release-attestation.md"
...
LIVE_52_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-52-execution-capsule-authz-final-authz-release-seal.md"
)
LIVE_52_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-52-execution-capsule-authz-final-authz-release-seal.md"
)
LIVE_52_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-52-execution-capsule-authz-final-authz-release-seal.md"
...
LIVE_53_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-53-execution-capsule-authz-final-authz-final-authorization.md"
)
LIVE_53_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-53-execution-capsule-authz-final-authz-final-authorization.md"
)
LIVE_53_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-53-execution-capsule-authz-final-authz-final-authorization.md"
...
LIVE_54_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-54-execution-capsule-authz-final-authz-final-authorization-export.md"
)
LIVE_54_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-54-execution-capsule-authz-final-authz-final-authorization-export.md"
)
LIVE_54_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-54-execution-capsule-authz-final-authz-final-authorization-export.md"
...
LIVE_57_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-57-execution-capsule-authz-final-authz-final-authorization-operator-decision.md"
)
LIVE_57_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-57-execution-capsule-authz-final-authz-final-authorization-operator-decision.md"
)
LIVE_57_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-57-execution-capsule-authz-final-authz-final-authorization-operator-decision.md"
...
LIVE_58_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-58-execution-capsule-authz-final-authz-final-authorization-release-attestation.md"
)
LIVE_58_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-58-execution-capsule-authz-final-authz-final-authorization-release-attestation.md"
)
LIVE_58_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-58-execution-capsule-authz-final-authz-final-authorization-release-attestation.md"
...
LIVE_59_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-59-execution-capsule-authz-final-authz-final-authorization-release-seal.md"
)
LIVE_59_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-59-execution-capsule-authz-final-authz-final-authorization-release-seal.md"
)
LIVE_59_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-59-execution-capsule-authz-final-authz-final-authorization-release-seal.md"
...
LIVE_60_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-60-execution-capsule-authz-final-authz-final-authorization-final-authorization.md"
)
LIVE_60_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-60-execution-capsule-authz-final-authz-final-authorization-final-authorization.md"
)
LIVE_60_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-60-execution-capsule-authz-final-authz-final-authorization-final-authorization.md"
...
LIVE_61_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-61-execution-capsule-authz-final-authz-final-authorization-final-authorization-export.md"
)
LIVE_61_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-61-execution-capsule-authz-final-authz-final-authorization-final-authorization-export.md"
)
LIVE_61_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-61-execution-capsule-authz-final-authz-final-authorization-final-authorization-export.md"
...
LIVE_62_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-62-execution-capsule-authz-final-authz-final-authorization-final-authorization-handoff.md"
)
LIVE_62_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-62-execution-capsule-authz-final-authz-final-authorization-final-authorization-handoff.md"
)
LIVE_62_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-62-execution-capsule-authz-final-authz-final-authorization-final-authorization-handoff.md"
...
LIVE_63_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-63-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-review.md"
)
LIVE_63_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-63-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-review.md"
)
LIVE_63_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-63-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-review.md"
...
LIVE_64_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-64-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-decision.md"
)
LIVE_64_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-64-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-decision.md"
)
LIVE_64_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-64-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-decision.md"
...
LIVE_65_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-65-execution-capsule-authz-final-authz-final-authorization-final-authorization-release-attestation.md"
)
LIVE_65_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-65-execution-capsule-authz-final-authz-final-authorization-final-authorization-release-attestation.md"
)
LIVE_65_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-65-execution-capsule-authz-final-authz-final-authorization-final-authorization-release-attestation.md"
...
LIVE_69_PATH = (
    ...
    / "docs"
    / "evals"
    / "aw-live-69-execution-capsule-authz-final-authz-final-authorization-final-authorization-final-authorization-handoff.md"
)
LIVE_69_RUNBOOK_PATH = (
    ROOT
    / "docs"
    / "runbooks"
    / "aw-live-69-execution-capsule-authz-final-authz-final-authorization-final-authorization-final-authorization-handoff.md"
)
LIVE_69_WORK_ORDER_PATH = (
    ROOT
    / "docs"
    / "work-orders"
    / "aw-live-69-execution-capsule-authz-final-authz-final-authorization-final-authorization-final-authorization-handoff.md"
...
LIVE_CHAIN_02_PATH = (
    ROOT / "docs" / "evals" / "aw-live-chain-02-no-call-boundary-helper-rollout.md"
)
LIVE_CHAIN_02_RUNBOOK_PATH = (
    ROOT / "docs" / "runbooks" / "aw-live-chain-02-no-call-boundary-helper-rollout.md"
)
LIVE_CHAIN_02_WORK_ORDER_PATH = (
    ROOT / "docs" / "work-orders" / "aw-live-chain-02-no-call-boundary-helper-rollout.md"
)
LIVE_CHAIN_03_PATH = (
    ROOT / "docs" / "evals" / "aw-live-chain-03-no-call-boundary-helper-rollout.md"
)
LIVE_CHAIN_03_RUNBOOK_PATH = (
    ROOT / "docs" / "runbooks" / "aw-live-chain-03-no-call-boundary-helper-rollout.md"
)
