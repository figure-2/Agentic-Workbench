# AW-LIVE-CHAIN-03 Runbook: No-Call Boundary Helper Rollout

## Purpose

Use this runbook to verify helper adoption across `AW-LIVE-53` through
`AW-LIVE-59`.
...
`AW-LIVE-55` uses the helper's `local_evidence_present` override so the export
...
Revert the `AW-LIVE-53` through `AW-LIVE-59` helper adoption and keep the
`AW-LIVE-CHAIN-02` helper usage in `AW-LIVE-60` through `AW-LIVE-68`.
