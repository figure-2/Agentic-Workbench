...
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_EXPORT_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-export-v1"
)
...
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_OPERATOR_DECISION_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-operator-decision-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_RELEASE_ATTESTATION_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-release-attestation-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_RELEASE_SEAL_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-release-seal-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_EXPORT_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-export-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_HANDOFF_PACKET_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-handoff-packet-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_OPERATOR_REVIEW_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-review-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_OPERATOR_DECISION_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-operator-decision-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_RELEASE_ATTESTATION_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-release-attestation-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_RELEASE_SEAL_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-release-seal-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-final-authorization-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_EXPORT_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-final-authorization-export-v1"
)
MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_HANDOFF_PACKET_VERSION = (
    "manual-provider-test-disabled-first-call-execution-capsule-authz-final-authz-final-authorization-final-authorization-final-authorization-handoff-packet-v1"
)
...
class _NoCallBoundaryEvaluation:
    reason: str
    boundary_hash: str
    claim_boundary_hash: str
    no_call_counters_hash: str
    component_count: int
    passed_component_count: int
    mismatch_count: int
    component_hash_count: int
    no_call_counter_count: int
    claim_boundary_check_count: int


def _evaluate_no_call_hash_boundary(
    *,
    projection_version: str,
    upstream_projection: JsonDict,
    upstream_expected_reason: str,
    upstream_hash: str,
    expected_upstream_hash: str,
    payload_present: bool,
    supplied_upstream_hash: str,
    local_evidence_hash: str,
    local_evidence_present: bool | None = None,
    request_present: bool,
    execution_boundary: JsonDict,
    reason_if_upstream_invalid: str,
    reason_if_expected_missing: str,
    reason_if_expected_mismatch: str,
    reason_if_payload_missing: str,
    reason_if_supplied_mismatch: str,
    reason_if_evidence_missing: str,
    reason_if_request_missing: str,
    reason_if_claim_boundary_mismatch: str,
    reason_if_no_call_mismatch: str,
    reason_if_complete: str,
    boundary_hash_components: JsonDict,
) -> _NoCallBoundaryEvaluation:
    ...
    upstream_projection_closed = (
        str(upstream_projection.get("status", "")) == "blocked"
        and str(upstream_projection.get("reason", "")) == upstream_expected_reason
        and bool(upstream_hash)
        and _coerce_int(upstream_projection.get("execution_permission_count", 0)) == 0
    )
    local_evidence_check = (
        bool(local_evidence_hash)
        if local_evidence_present is None
        else local_evidence_present
    )
    component_checks = [
        upstream_projection_closed,
        bool(expected_upstream_hash) and expected_upstream_hash == upstream_hash,
        payload_present,
        bool(supplied_upstream_hash) and supplied_upstream_hash == upstream_hash,
        local_evidence_check,
        request_present,
        claim_boundary_closed,
    ...
    component_hash_count = sum(
        1
        for value in (
            *boundary_hash_components.values(),
            claim_boundary_hash,
            no_call_counters_hash,
        )
        if value
    ...
    if not component_checks[0]:
        reason = reason_if_upstream_invalid
    elif not expected_upstream_hash:
        reason = reason_if_expected_missing
    elif expected_upstream_hash != upstream_hash:
        reason = reason_if_expected_mismatch
    elif not component_checks[2]:
        reason = reason_if_payload_missing
    elif not component_checks[3]:
        reason = reason_if_supplied_mismatch
    elif not component_checks[4]:
        reason = reason_if_evidence_missing
    elif not component_checks[5]:
        reason = reason_if_request_missing
    elif not component_checks[6]:
        reason = reason_if_claim_boundary_mismatch
    elif not component_checks[7]:
        reason = reason_if_no_call_mismatch
    else:
        reason = reason_if_complete

    boundary_hash = ""
    if mismatch_count == 0:
        boundary_hash = stable_contract_hash(
            {
                "projection_version": projection_version,
    ...
    return _NoCallBoundaryEvaluation(
        reason=reason,
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
            ...
            "counts": {
                "execution_capsule_authz_final_authz_final_authz_export_count": 0,
                "component_count": 0,
                "execution_permission_count": 0,
            },
        }
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
            ...
            "counts": {
                "execution_capsule_authz_final_authz_final_authz_final_authz_export_count": 0,
                "component_count": 0,
                "execution_permission_count": 0,
            },
        }
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
            ...
            "counts": {
                "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_count": 0,
                "component_count": 0,
                "execution_permission_count": 0,
            },
        }
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_blocked(
    reason: str,
) -> JsonDict:
    return _safe_public_payload(
        {
...
def _manual_provider_test_execution_capsule_authz_final_authorization_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_release_seal,
        upstream_expected_reason="execution_capsule_authz_release_seal_execution_closed",
        ...
        reason_if_expected_mismatch=(
            "execution_capsule_authz_release_seal_hash_mismatch"
        ),
        reason_if_payload_missing="execution_capsule_authz_final_authz_required",
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_seal_hash_mismatch"
        ),
        reason_if_evidence_missing="execution_capsule_authz_final_authz_required",
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_no_call_counters_mismatch"
        ),
        reason_if_complete="execution_capsule_authz_final_authz_execution_closed",
        boundary_hash_components={
...
def _manual_provider_test_execution_capsule_authz_final_authz_export_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz,
        upstream_expected_reason="execution_capsule_authz_final_authz_execution_closed",
        ...
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_export_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_export_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_export_metadata_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_export_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_handoff_packet_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_export,
        ...
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_handoff_packet_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_export_read_model_missing_or_mismatched"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_handoff_packet_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_operator_review_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_handoff_packet,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_handoff_packet_execution_closed"
        ),
        ...
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_operator_review_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_operator_decision_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_operator_review,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_operator_review_execution_closed"
        ),
        ...
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_operator_review_hash_mismatch"
        ),
        reason_if_payload_missing=(
        ...
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_operator_decision_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_release_attestation_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_operator_decision,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_operator_decision_execution_closed"
        ),
        ...
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_operator_decision_hash_mismatch"
        ),
        reason_if_payload_missing=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_release_seal_projection(
    *,
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_release_attestation,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_release_attestation_execution_closed"
        ),
        ...
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_release_seal_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_release_seal_attestation_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_release_seal_material_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_release_seal_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    final_authz_hash = str(
    ...
    supplied_final_authz_hash = str(
        export_payload.get("execution_capsule_authz_final_authz_final_authz_hash", "")
    ).strip()
    export_metadata = (
        export_payload.get("export_metadata")
        if isinstance(export_payload.get("export_metadata"), dict)
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_projection(
    export_projection: JsonDict,
) -> JsonDict:
    if (
        str(export_projection.get("status", "")) == "blocked"
        ...
        return _safe_public_payload(
            {
                ...
                "latest_execution_capsule_authz_final_authz_final_authz_export_hash": str(
                    export_projection.get(
                        "execution_capsule_authz_final_authz_final_authz_export_hash",
                        "",
                    )
                ...
                "counts": {
                    "execution_capsule_authz_final_authz_final_authz_export_count": int(
                        export_projection.get("export_count", 0)
                    ),
                    "component_count": int(
                        export_projection.get("component_count", 0)
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_blocked(
            "execution_capsule_authz_final_authz_final_authz_export_not_available"
        )
    )


def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_export: JsonDict,
    execution_capsule_authz_final_authz_final_authorization_export_read_model: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    export_hash = str(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_operator_review: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    operator_review_hash = str(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_operator_decision: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    operator_decision_hash = str(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_release_attestation: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    release_attestation_hash = str(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_release_seal: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    release_seal_hash = str(
        execution_capsule_authz_final_authz_final_authorization_release_seal.get(
            "execution_capsule_authz_final_authz_final_authz_release_seal_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_release_seal,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_release_seal_execution_closed"
        ),
        upstream_hash=release_seal_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_release_seal_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_release_seal_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_release_seal_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_seal_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    final_authz_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_final_authorization,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_execution_closed"
        ),
        upstream_hash=final_authz_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_final_authz_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_metadata_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_projection(
    export_projection: JsonDict,
) -> JsonDict:
    if (
        str(export_projection.get("status", "")) == "blocked"
        ...
        return _safe_public_payload(
            {
                ...
                "latest_execution_capsule_authz_final_authz_final_authz_final_authz_export_hash": str(
                    export_projection.get(
                        "execution_capsule_authz_final_authz_final_authz_final_authz_export_hash",
                        "",
                    )
                ...
                "counts": {
                    "execution_capsule_authz_final_authz_final_authz_final_authz_export_count": int(
                        export_projection.get("export_count", 0)
                    ),
                    "component_count": int(
                        export_projection.get("component_count", 0)
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_not_available"
        )
    )


def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_export: JsonDict,
    execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    export_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_export.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_hash",
            "",
        )
    ).strip()
    ...
    read_model_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model.get(
            "latest_execution_capsule_authz_final_authz_final_authz_final_authz_export_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_final_authorization_export,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_execution_closed"
        ),
        upstream_hash=export_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
        ...
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_read_model_missing_or_mismatched"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    handoff_packet_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_execution_closed"
        ),
        upstream_hash=handoff_packet_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
        ...
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_handoff_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    operator_review_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_execution_closed"
        ),
        upstream_hash=operator_review_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_review_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    operator_decision_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_execution_closed"
        ),
        upstream_hash=operator_decision_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_decision_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    release_attestation_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation,
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_execution_closed"
        ),
        upstream_hash=release_attestation_hash,
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_attestation_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_material_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    release_seal_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=(
            execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal
        ),
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_execution_closed"
        ),
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_seal_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    final_authz_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_hash",
            "",
        )
    ).strip()
    ...
    evaluation = _evaluate_no_call_hash_boundary(
        ...
        upstream_projection=(
            execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization
        ),
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_execution_closed"
        ),
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
            "expected_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_hash_required"
        ),
        reason_if_expected_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_hash_mismatch"
        ),
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_metadata_required"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_projection(
    export_projection: JsonDict,
) -> JsonDict:
    if (
        str(export_projection.get("status", "")) == "blocked"
        ...
        return _safe_public_payload(
            {
                ...
                "latest_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_hash": str(
                    export_projection.get(
                        "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_hash",
                        "",
                    )
                ...
                "counts": {
                    "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_count": int(
                        export_projection.get("export_count", 0)
                    ),
                    "component_count": int(
                        export_projection.get("component_count", 0)
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_not_available"
        )
    )


def _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_projection(
    *,
    payload: dict[str, Any],
    execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export: JsonDict,
    execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model: JsonDict,
    execution_boundary: JsonDict,
) -> JsonDict:
    export_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export.get(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_hash",
            "",
        )
    ).strip()
    ...
    read_model_hash = str(
        execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model.get(
            "latest_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_hash",
            "",
        )
    ).strip()
    ...
    read_model_available = (
        ...
        and bool(read_model_hash)
        and read_model_hash == export_hash
        and _coerce_int(read_model_counts.get("execution_permission_count", 0)) == 0
    )
    evaluation = _evaluate_no_call_hash_boundary(
        projection_version=(
            MANUAL_PROVIDER_TEST_EXECUTION_CAPSULE_AUTHZ_FINAL_AUTHZ_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_FINAL_AUTHORIZATION_HANDOFF_PACKET_VERSION
        ...
        upstream_projection=(
            execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export
        ),
        upstream_expected_reason=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_execution_closed"
        ),
        ...
        execution_boundary=execution_boundary,
        reason_if_upstream_invalid=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_missing_or_mismatched"
        ),
        reason_if_expected_missing=(
        ...
        reason_if_payload_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_handoff_packet_required"
        ),
        reason_if_supplied_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_handoff_packet_hash_mismatch"
        ),
        reason_if_evidence_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_read_model_missing_or_mismatched"
        ),
        reason_if_request_missing=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_handoff_packet_request_required"
        ),
        reason_if_claim_boundary_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_handoff_packet_claim_boundary_mismatch"
        ),
        reason_if_no_call_mismatch=(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_handoff_packet_no_call_counters_mismatch"
        ),
        reason_if_complete=(
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_export_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization export."""
    authz_final_authz_final_authorization = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_projection(
            payload=payload,
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization export read model."""
    authz_final_authz_final_authorization_export = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_export_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_projection(
            authz_final_authz_final_authorization_export
        )
    )


def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization handoff packet."""
    authz_final_authz_final_authorization_export = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_export_summary(
            payload
        )
    )
    authz_final_authz_final_authorization_export_read_model = (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_projection(
            authz_final_authz_final_authorization_export
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_export=(
                authz_final_authz_final_authorization_export
            ),
            execution_capsule_authz_final_authz_final_authorization_export_read_model=(
                authz_final_authz_final_authorization_export_read_model
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization operator decision."""
    authz_final_authz_final_authorization_operator_review = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_operator_review_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_projection(
            payload=payload,
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization release attestation."""
    authz_final_authz_final_authorization_operator_decision = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_operator_decision=(
                authz_final_authz_final_authorization_operator_decision
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_release_seal_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization release seal."""
    authz_final_authz_final_authorization_release_attestation = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_release_attestation=(
                authz_final_authz_final_authorization_release_attestation
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization."""
    authz_final_authz_final_authorization_release_seal = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_release_seal_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_release_seal=(
                authz_final_authz_final_authorization_release_seal
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization export."""
    authz_final_authz_final_authorization_final_authorization = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization=(
                authz_final_authz_final_authorization_final_authorization
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization export read model."""
    authz_final_authz_final_authorization_final_authorization_export = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_projection(
            authz_final_authz_final_authorization_final_authorization_export
        )
    )


def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization handoff packet."""
    authz_final_authz_final_authorization_final_authorization_export = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_summary(
            payload
        )
    )
    authz_final_authz_final_authorization_final_authorization_export_read_model = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_export=(
                authz_final_authz_final_authorization_final_authorization_export
            ),
            execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model=(
                authz_final_authz_final_authorization_final_authorization_export_read_model
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization operator review."""
    authz_final_authz_final_authorization_final_authorization_handoff_packet = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet=(
                authz_final_authz_final_authorization_final_authorization_handoff_packet
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization operator decision."""
    authz_final_authz_final_authorization_final_authorization_operator_review = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review=(
                authz_final_authz_final_authorization_final_authorization_operator_review
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization release attestation."""
    authz_final_authz_final_authorization_final_authorization_operator_decision = (
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision=(
                authz_final_authz_final_authorization_final_authorization_operator_decision
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization release seal."""
    authz_final_authz_final_authorization_final_authorization_release_attestation = (
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation=(
                authz_final_authz_final_authorization_final_authorization_release_attestation
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization final authorization."""
    authz_final_authz_final_authorization_final_authorization_release_seal = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_summary(
            payload
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal=(
                authz_final_authz_final_authorization_final_authorization_release_seal
            ),
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization final authorization export."""
    authz_final_authz_final_authorization_final_authorization_final_authorization = (
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization=(
                authz_final_authz_final_authorization_final_authorization_final_authorization
            ),
...
def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization final authorization export read model."""
    authz_final_authz_final_authorization_final_authorization_final_authorization_export = (
    ...
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_projection(
            authz_final_authz_final_authorization_final_authorization_final_authorization_export
        )
    )


def provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_summary(
    payload: dict[str, Any],
) -> dict[str, Any]:
    """Build the public no-call first-call execution capsule authz final authz final authorization final authorization final authorization handoff packet."""
    authz_final_authz_final_authorization_final_authorization_final_authorization_export = (
        provider_manual_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_summary(
            payload
        )
    )
    authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model = (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_projection(
            authz_final_authz_final_authorization_final_authorization_final_authorization_export
        )
    )
    return (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export=(
                authz_final_authz_final_authorization_final_authorization_final_authorization_export
            ),
            execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model=(
                authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model
            ),
            execution_boundary=_zero_execution_boundary(),
        )
...
def _blocked_projection(
    *,
    ...
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model: JsonDict | None = None,
    manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet: JsonDict | None = None,
) -> dict[str, Any]:
    ...
    selected_execution_capsule_authz_final_authz_final_authorization_export = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_blocked(
            "execution_capsule_authz_final_authz_final_authz_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_export_read_model = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_read_model_projection(
            selected_execution_capsule_authz_final_authz_final_authorization_export
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_handoff_packet = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet_blocked(
    ...
    selected_execution_capsule_authz_final_authz_final_authorization_operator_decision = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_blocked(
            "execution_capsule_authz_final_authz_final_authz_operator_review_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_release_attestation = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_blocked(
            "execution_capsule_authz_final_authz_final_authz_operator_decision_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_release_seal = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal_blocked(
            "execution_capsule_authz_final_authz_final_authz_release_attestation_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_blocked(
            "execution_capsule_authz_final_authz_final_authz_release_seal_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_export = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_read_model_projection(
            selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_export
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_export_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_not_evaluated"
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_read_model_projection(
            selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export
        )
    )
    selected_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet = (
        manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet
        or _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_blocked(
            "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_not_evaluated"
        )
    )
    return _safe_public_payload(
        {
...
def _projection_from_result(
    *,
    ...
    execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet = (
        _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_projection(
            payload=payload,
            execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export=(
                execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export
    ...
    return _safe_public_payload(
        {
            ...
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_export": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_export_blocked(
                    "execution_capsule_authz_final_authz_final_authz_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_export_read_model": (
            ...
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_handoff_packet": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_handoff_packet_blocked(
                    "execution_capsule_authz_final_authz_final_authz_export_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_operator_review": (
            ...
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_operator_decision": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_operator_decision_blocked(
                    "execution_capsule_authz_final_authz_final_authz_operator_review_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_release_attestation": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_attestation_blocked(
                    "execution_capsule_authz_final_authz_final_authz_operator_decision_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_release_seal": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_release_seal_blocked(
                    "execution_capsule_authz_final_authz_final_authz_release_attestation_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_blocked(
                    "execution_capsule_authz_final_authz_final_authz_release_seal_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_export": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_export_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_export_read_model": (
            ...
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_handoff_packet_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_export_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_operator_review": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_review_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_handoff_packet_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_operator_decision_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_operator_review_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_attestation_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_operator_decision_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_release_seal": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_release_seal_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_release_attestation_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_release_seal_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_export_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_missing_or_mismatched"
                )
            ),
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_read_model": (
            ...
            "manual_provider_test_execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_handoff_packet": (
                _manual_provider_test_execution_capsule_authz_final_authz_final_authorization_final_authorization_final_authorization_handoff_packet_blocked(
                    "execution_capsule_authz_final_authz_final_authz_final_authz_final_authz_export_missing_or_mismatched"
                )
            ),
            "provider_envelope_read_model": read_model,
